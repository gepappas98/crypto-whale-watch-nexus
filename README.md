# 🐋 Whale Radar (crypto-whale-watch-nexus) — v9.26

![Version](https://img.shields.io/badge/version-9.26-blue)
...
- P1 (current focus): restructured Regime Council desk, decision-outcome loop, regime-transition alert delivery, real market breadth, stablecoin/liquidity flow, BTC/ETH relative strength, historical signal evaluation.
