# 🐋 Whale Radar (crypto-whale-watch-nexus) — v9.25

![Version](https://img.shields.io/badge/version-9.25-blue)
...
- Alert-channel delivery (Telegram/Discord) specifically for regime transitions — the panel is in-app only right now; a regime flipping to CONFIRMED EARLY BULL doesn't push a notification yet.
