# 🐋 Whale Radar (crypto-whale-watch-nexus) — v9.8
...
Both previously-open items are closed as of v9.7/v9.8 — see ✅ Done below. Nothing currently outstanding; next candidates would need a new gap identified (e.g. via a fresh pass over `freqtrade-develop` or a fresh look at what's stubbed vs. real in Nexus/Council).
